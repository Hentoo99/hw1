...
<!DOCTYPE html>
<html>
<link rel="stylesheet" href="page_desciption_style.css">
...
<script src="script/loading_description.js" defer></script>
...
<head>
    ...
    <body >
        ...
        <section>
            <img src="immagini/logo.png" alt="MISSING PNG">
            <div class="description">
                <p><em>PoolParty</em> nasce da un'idea di Enricomaria durante la progettazione di una parte del corso di Database and Web Programming</p><br>
                <p> PoolParty ha come obiettivo quello di far conoscere l'ambiente sportivo 
                e competitivo che la piscina riesce a creare.
                 Avvolgendo la persona a 360°  e aiutandola ad acquisire 
                 il benessere fisico, psichico e mentale</p>
            </div>
        ...
        <footer>
            <span>
                <img class="profilo" src="immagini/me.png" >
